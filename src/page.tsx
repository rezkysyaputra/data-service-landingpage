      ...
      <section className="py-8 md:py-12 lg:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <img
                src="public/images/hero-removebg-preview.png"
                alt="Hero Image"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12  items-center">
            <div className="flex justify-center order-2 lg:order-1">
              <img
                src="public/images/section-services.png"
                alt="services_image"
              />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="mx-auto order-2 lg:order-1">
              <img src="public/images/section-whyus.png" alt="why_us" />
            </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center">
            <img
              src="public/images/workflow-service.png"
